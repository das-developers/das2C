 ...
 *
 * Note what is NOT included: set.h.  A form is handed das_operand snapshots
 * and never reaches up.  Nor generator.h -- forms compute, sets walk.
 *
 * Wire:
 *
...
/* No binOpRight.  Nothing is defined with a rotation on the RIGHT: v * R is
   ...
   declines and this hook does not exist, new_DasBinSet fails loud, which is
   the correct answer. */
