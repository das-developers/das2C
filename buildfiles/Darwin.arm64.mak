# Building on Apple Silicon, compiler etc. are different, we can't depend on
# gcc anymore.
...
UTIL_PROGS=das1_inctime das2_prtime das1_fxtime das2_ascii das2_bin_avg \
 ...
 das2_cache_rdr das_node das3_csv das3_test das3_text
...
CFLAGS=-g -fPIC -std=c99 -Wno-format-security -I. $(SSL_INC) $(DEFINES) -I$(BREW_INC_DIR)
#CFLAGS=-Wall -DNDEBUG -O2 -fPIC -std=c99 -I. $(DEFINES)

CTESTFLAGS=-g -Wall -fPIC -std=c99 -I. $(SSL_INC)
